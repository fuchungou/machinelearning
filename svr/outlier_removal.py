...
for iteration in range(max_iterations):
    ...
    model = SVR(kernel='rbf', C=78, epsilon=0.01, gamma='auto')
...
results_df = pd.DataFrame({
    ...
    'Actual Values': y_test_sorted,
    'Predicted Values': y_test_pred_sorted
})
results_df.to_csv('../data/sorted_actual_vs_predicted.csv', index=False)